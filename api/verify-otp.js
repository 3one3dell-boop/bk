...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    console.error("customToken mint failed:", e);
    // فشل توليد التوكن لا يفترض يصير أبداً بالتشغيل الطبيعي — نرجّع خطأ
    // واضح بدل ما نرجّع نجاح جزئي مربك للعميل (اللي يتحقق من customToken تحديداً)
